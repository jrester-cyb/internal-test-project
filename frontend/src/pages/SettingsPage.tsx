...
import { Container, Box, Typography, Paper, List, ListItemButton, ListItemIcon, ListItemText } from '@mui/material'
import {
  Business as OrganizationIcon,
  Workspaces as WorkspaceIcon,
  AdminPanelSettings as InstanceIcon,
...
export default function SettingsPage() {
  ...
  ], [activeOrganization, activeWorkspace, canManageRoles, canManageUsers, canManageOrganizations, canManageOrganization, canManageWorkspace])
